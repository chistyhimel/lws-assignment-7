    ...
    <div className="flex gap-4 items-center">
      <div className="relative">
        ...
        >
          <Image
            className="max-w-8"
            src={`/assets/${selectedLanguage.code == "bn" ? "bd" : "usa"}.png`}
            alt="bangla"
            height={100}
            width={165}
          />
        ...
        {showManu && (
          <div className="absolute right-0 top-full mt-2 w-40 rounded-md bg-slate-900 p-2 z-10 shadow-lg">
            {languages.map((entry) => (
              <li
                key={entry.code}
              ...
              >
                <Image
                  className="max-w-8"
                  src={`/assets/${entry.code == "bn" ? "bd" : "usa"}.png`}
                  alt="bangla"
                  height={100}
                  width={165}
                />
